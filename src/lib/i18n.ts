...
export const dict = {
  en: {
    ...
    onboarding: {
      slide1: { title: "Welcome to Circle", body: "One app. Every conversation, video, photo, payment and journey — beautifully unified." },
      slide2: { title: "Eight worlds. One Circle.", body: "Wasl, Mashahd, Lamahat, Midan, Rihla, Pay, Mail and your AI co-pilot. All free, forever." },
    ...
    home: {
      ...
      miniApps: "Mini apps inside Circle",
      mail: "Circle Mail",
      mailSub: "3 new · 1 needs a reply",
      id: "Circle ID · Verified",
      idSub: "One identity across every Circle service",
